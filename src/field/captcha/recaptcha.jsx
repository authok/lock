    ...
    */
    ...
    return (
      <div
        className={
          this.props.isValid
            ? 'authok-lock-recaptcha-block'
            : 'authok-lock-recaptcha-block authok-lock-recaptcha-block-error'
        }
      >
        <div className="authok-lock-recaptchav2" ref={this.ref} />
      </div>
    );
  }

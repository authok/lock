...
export default {
  error: {
    ...
    login: {
      ...
      'lock.network':
        'Kami tidak dapat mencapai pelayan. Sila periksa sambungan anda dan cuba lagi.',
      ...
      password_change_required:
        'Anda perlu mengemas kini kata laluan anda kerana ini merupakan kali pertama anda mengelog masuk, atau kerana kata laluan anda telah tamat tempoh.',
      password_leaked:
      ...
      too_many_attempts:
        'Akaun anda telah disekat selepas berbilang percubaan log masuk yang berturut-turut.',
      session_missing:
      ...
      too_many_requests:
        'Kami minta maaf. Terlalu banyak permintaan sekarang. Muat semula halaman dan cuba lagi. Sekiranya ini berterusan, cuba lagi kemudian.'
    },
    passwordless: {
  ...
  success: {
    ...
    forgotPassword:
      'Kami baru saja menghantar e-mel kepada anda untuk menetapkan semula kata laluan anda.',
  ...
  passwordStrength: {
    ...
    identicalChars:
      'Tidak lebih daripada %d aksara yang serupa berturut-turut (cth."%s" tidak dibenarkan)',

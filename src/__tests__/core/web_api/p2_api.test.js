...
const getAuthokClientMock = () => require('authok-js');
...
describe('AuthokAPIClient', () => {
  beforeEach(() => {
    jest.resetModules();
    require('@authok/authok-js').version.raw = 'a0js.version';
  ...
  describe('init', () => {
    describe('with overrides', () => {
      ...
      it('uses default telemetry key when outside the ULP', () => {
        ...
        expect(Object.keys(mock.WebAuth.mock.calls[0][0]._telemetryInfo.env)).toContain('authok.js');
      });
      it('overrides authok.js telemetry key', () => {
        setURL(`https://auth.myapp.com/authorize`);
        const options = {
          audience: 'foo',
          redirectUrl: '//localhost:8080/login/callback',
          ...
          _telemetryInfo: {
            name: 'test-sdk',
            version: '1.0.0',
            env: { 'authok.js': 'this-will-be-overriden' }
          }
        };
        getClient(options);
        const mock = getAuthokClientMock();
  ...
  describe('logIn', () => {
    ...
    describe('should trim spaces in', () => {
      let client;
      let callback;
      let getMock = () => getAuthokClientMock().WebAuth.mock.instances[0].login.mock;
      beforeEach(() => {
        client = getClient({
          redirect: true
        });
  ...
  describe('signUp', () => {
    describe('should trim spaces in', () => {
      let client;
      let callback;
      let getMock = () => getAuthokClientMock().WebAuth.mock.instances[0].signup.mock;
      beforeEach(() => {
        client = getClient({
          redirect: true
        });
  ...
  describe('resetPassword', () => {
    describe('should trim spaces in', () => {
      let client;
      let callback;
      let getMock = () => getAuthokClientMock().WebAuth.mock.instances[0].changePassword.mock;
      beforeEach(() => {
        client = getClient({
          redirect: true
        });
  ...
  describe('passwordlessStart', () => {
    ...
    describe('should trim spaces in', () => {
      let client;
      let callback;
      let getMock = () => getAuthokClientMock().WebAuth.mock.instances[0].passwordlessStart.mock;
      beforeEach(() => {
        client = getClient({
          redirect: true
        });
  ...
  describe('passwordlessVerify', () => {
    ...
    describe('should trim spaces in', () => {
      let client;
      let callback;
      let getMock = () => getAuthokClientMock().WebAuth.mock.instances[0].passwordlessLogin.mock;
      beforeEach(() => {
        client = getClient({
          redirect: true
        });

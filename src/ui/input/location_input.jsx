...
export const IconSvg = (
  <svg
    ...
    className="authok-lock-icon authok-lock-icon-box authok-lock-icon-location"
  >
...
const ArrowIconSvg = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    xmlnsXlink="http://www.w3.org/1999/xlink"
    className="authok-lock-icon authok-lock-icon-box authok-lock-icon-arrow"
  >
    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g
        id="Lock"
    ...
    return (
      <InputWrap focused={focused} isValid={true} name="location" icon={IconSvg}>
        <input
          type="button"
          name="location"
          className="authok-lock-input authok-lock-input-location"
          value={limitedValue}

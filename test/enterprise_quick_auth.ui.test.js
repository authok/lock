...
describe('enterprise quick auth', function() {
  ...
  describe("when there's only an authok-adldap connection", function() {
    beforeEach(function(done) {
      const opts = {
        allowedConnections: ['authok-adldap.com'],
        rememberLastLogin: false
      };
  ...
  describe("when there's only a custom connection", function() {
    ...
    it('shows a login button with the default icon', function() {
      expect(h.hasQuickAuthButton(this.lock, 'authok', 'custom.com')).to.be.ok();
    });
  });
  ...
  describe("when there's only a google-apps connection", function() {
    ...
    it('shows a login button with the google icon', function(done) {
      h.waitUntilExists(this.lock, '.authok-lock-social-button', () => {
  ...
  describe("when there's only an ip connection", function() {
    ...
    it('shows a login button with the default icon', function() {
      expect(h.hasQuickAuthButton(this.lock, 'authok', 'ip.com')).to.be.ok();
    });
  });
  ...
  describe("when there's only a mscrm connection", function() {
    ...
    it('shows a login button with the default icon', function() {
      expect(h.hasQuickAuthButton(this.lock, 'authok', 'mscrm.com')).to.be.ok();
    });
  });
  ...
  describe("when there's only a pingfederate connection", function() {
    ...
    it('shows a login button with the default icon', function() {
      expect(h.hasQuickAuthButton(this.lock, 'authok', 'pingfederate.com')).to.be.ok();
    });
  });
  ...
  describe("when there's only a samlp connection", function() {
    ...
    it('shows a login button with the default icon', function() {
      expect(h.hasQuickAuthButton(this.lock, 'authok', 'samlp.com')).to.be.ok();
    });
  });
  ...
  describe("when there's only a sharepoint connection", function() {
    ...
    it('shows a login button with the default icon', function() {
      expect(h.hasQuickAuthButton(this.lock, 'authok', 'sharepoint.com')).to.be.ok();
    });
  });

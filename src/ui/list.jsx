...
export default class FiltrableList extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="authok-lock-select-country">
        <div className="authok-lock-search">
...
class List extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="authok-lock-list-code" onMouseLeave={::this.mouseLeaveHandler}>
        <ul>{items}</ul>
      </div>
    );
  }
...
class Item extends React.Component {
  ...
  render() {
    ...
    const className = highlighted ? 'authok-lock-list-code-highlighted' : '';

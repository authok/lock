...
export default {
  error: {
    ...
    login: {
      ...
      password_leaked:
        'Parolunuz başqa bir veb saytında yayımlandığı üçün bu giriş cəhdi blok edildi. Kilidi açmaq üçün sizə e-poçt göndərdik.',
  ...
  forgotPasswordInstructions:
    'Zəhmət olmasa, e-mail adresinizi daxil edin. Parolunuzu yeniləmək üçün sizə e-poçt göndərəcəyik.',
  ...
  passwordStrength: {
    containsAtLeast:
      'Ən az %d müxtəlif növ simvollardan istifadə edilməlidir. Alt-da istifadə oluna bilər %d müxtəlif növlər verilmişdir.',
  ...
  passwordlessEmailAlternativeInstructions:
    'Əks halda, giriş üçün e-poçt adresinizi daxil edin<br/>ya da qeydiyyatdan keçin',

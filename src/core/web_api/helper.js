export function normalizeError(error, domain) {
  ...
  // TODO: the following checks were copied from https://github.com/authok/lock/blob/0a5abf1957c9bb746b0710b274d0feed9b399958/index.js#L1263-L1288
  ...
  // We need a better errror handling story in authok.js.
...
export function trimAuthParams(params = {}) {
  const { ...p } = params;
  ['username', 'email', 'phoneNumber', 'mfa_code', 'vcode', 'password'].forEach(k => {

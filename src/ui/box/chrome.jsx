...
export default class Chrome extends React.Component {
  ...
  focusError() {
    ...
    const error = node.querySelector('.authok-lock-error input');
  ...
  render() {
    ...
    const className = classnames('authok-lock-cred-pane', {
      ...
      'authok-lock-moving': !isQuiet
    });

    const internalWrapperClass = classnames('authok-lock-cred-pane-internal-wrapper', {
    ...
    return (
      <div className={className}>
        <div className={internalWrapperClass}>
          <div className="authok-lock-content-wrapper">
            <Header
              title={title}
              name={name}
            ...
            <div
              className="authok-lock-content-body-wrapper"
            ...
            >
              ...
              <div style={{ position: 'relative' }} ref="screen">
                <MultisizeSlide
                  ...
                  reverse={reverse}
                >
                  <div key={this.mainScreenName()} className="authok-lock-view-content">
                    <div style={{ position: 'relative' }}>
                      <div className="authok-lock-body-content">
                        <div className="authok-lock-content">
                          <div className="authok-lock-form">
                            <Content focusSubmit={::this.focusSubmit} {...contentProps} />
                          </div>
                        </div>
                        {terms && <small className="authok-lock-terms">{terms}</small>}
                      </div>
                    </div>
                  </div>
                </MultisizeSlide>

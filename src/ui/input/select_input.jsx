...
const ArrowIconSvg = () => (
  <svg
    ...
    className="authok-lock-icon-arrow"
  >
...
export default class SelectInput extends React.Component {
  ...
  render() {
    ...
    if (!icon && typeof iconUrl === 'string' && iconUrl) {
      icon = <img className="authok-lock-custom-icon" alt={ariaLabel || name} src={iconUrl} />;
    }

    let className = 'authok-lock-input authok-lock-input-location';
    if (!label) className += ' authok-lock-input-with-placeholder';

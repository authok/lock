...
export default {
  error: {
    ...
    login: {
      ...
      password_change_required:
        'Morate ažurirati lozinku pošto je ovo prvi put da se prijavljujete ili zbog toga što je lozinka istekla.',
      password_leaked:
      ...
      too_many_requests:
        'Жао нам је. Тренутно има превише захтева. Поново учитајте страницу и покушајте поново. Ако се то настави, покушајте поново касније.'
    },
    passwordless: {
  ...
  mfaLoginInstructions:
    'Unesite kôd za verifikaciju koji je generisan u vašoj aplikaciji za mobilne uređaje',

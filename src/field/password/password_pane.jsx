...
export default class PasswordPane extends React.Component {
  ...
  render() {
    ...
    const hiddenCss = hidden ? ' authok-lock-hidden' : '';
    ...
    return (
      <div className={`authok-lock-input-block authok-lock-input-show-password${hiddenCss}`}>
        <PasswordInput
        ...
        {l.ui.allowShowPassword(lock) && (
          <div className="authok-lock-show-password">

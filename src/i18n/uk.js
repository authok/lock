...
export default {
  error: {
    ...
    login: {
      ...
      too_many_requests:
        'Нам шкода. Зараз занадто багато запитів. Перезавантажте сторінку та повторіть спробу. Якщо це триває, спробуйте знову пізніше.'
    },
    passwordless: {
  ...
  usernameOrEmailOrPhoneNumberInputPlaceholder: 'ім’я користувача/адреса електронної пошти',
  title: 'Authok',
